...
export const Profile = ({ dateTime }: ProfileType) => {
  ...
  return (
    <div
      className={`relative flex md:flex w-full lg:w-2/4 h-[250px] 
    ...
    >
      ...
      <div className="flex  w-3/4  sm:w-2/4 md:w-1/3 lg:w-2/4">
        <div className="flex w-1/3 flex-col mr-2">
          <p className="text-xl my-1">Email: </p>
          <p className="text-xl">UserName: </p>
          <p className="text-xl">Specialization: </p>
          <p className="text-xl my-1">Created: </p>
        </div>
        <div className="flex  w-2/3  items-end  flex-col">
          ...
          <p className="text-lg my-1">{dateTime}</p>
        </div>
      </div>
      <div className="flex  justify-end  w-3/4 lg:w-2/4 h-full mt-4">
        <div className="flex my-4 justify-center items-center w-full max-w-[160px]  ease-in-out duration-300 hover:bg-neutral-800  hover:text-white  hover:border-none h-[48px] border-[1px] border-neutral-800  text-black rounded-lg cursor-pointer mr-2">
          Orders
        </div>
        <div className="flex my-4 justify-center items-center w-full max-w-[160px]  ease-in-out duration-300 hover:bg-neutral-800  hover:text-white  hover:border-none h-[48px] border-[1px] border-neutral-800  text-black rounded-lg cursor-pointer">
          Address
        </div>
      </div>
    </div>
